...
func deactivate():
	...
	create_tween().tween_property(self, "self_modulate:a", INACTIVE_ALPHA, 1.0).set_ease(Tween.EASE_OUT).set_trans(Tween.TRANS_CUBIC)
