...
func enter_storm(tween : Tween, duration : float):
	...
	tween.tween_method(set_darken.bind(true), 0.0, 0.3, duration).set_trans(Tween.TRANS_CUBIC).set_ease(Tween.EASE_IN_OUT)
	...
	tween.tween_method(set_darken.bind(false), 0.0, 0.3, duration).set_trans(Tween.TRANS_CUBIC).set_ease(Tween.EASE_IN_OUT)
...
func exit_storm(tween : Tween, duration : float):
	...
	tween.tween_method(set_darken.bind(true), 0.3, 0.0, duration).set_trans(Tween.TRANS_CUBIC).set_ease(Tween.EASE_IN_OUT)
	...
	tween.tween_method(set_darken.bind(false), 0.3, 0.0, duration).set_trans(Tween.TRANS_CUBIC).set_ease(Tween.EASE_IN_OUT)
